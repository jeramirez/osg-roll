	...
	def run(self, params, args):
		...
		self.beginOutput()
			...
			if trigger_install:
				...
				self.addOutput(self.host, 'yum -y install osg-se-hadoop-client  &gt;&gt; %s 2&gt;&amp;1' % loginstall)
				self.addOutput(self.host, 'yum -y install osg-se-hadoop-datanode  &gt;&gt; %s 2&gt;&amp;1' % loginstall)
				self.addOutput(self.host, 'yum -y install osg-se-hadoop-namenode  &gt;&gt; %s 2&gt;&amp;1' % loginstall)
				self.addOutput(self.host, 'yum -y install osg-se-hadoop-secondarynamenode  &gt;&gt; %s 2&gt;&amp;1' % loginstall)
