	...
	def run(self, params, args):
		...
		self.beginOutput()
			...
			if osg_ce > 0:
				...
				self.addOutput(self.host, 'yum install lcmaps  &gt;&gt; /var/log/ce-install.log 2&gt;&amp;1')
				self.addOutput(self.host, 'yum install vo-client-lcmaps-voms  &gt;&gt; /var/log/ce-install.log 2&gt;&amp;1')
